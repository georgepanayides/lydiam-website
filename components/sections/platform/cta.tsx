        ...
        <div className="max-w-4xl mx-auto text-center">
          <FadeIn>
            <h2 className="font-organetto text-3xl md:text-5xl font-bold text-dark-900 dark:text-white mb-6 leading-tight">
              ...
              <span className="text-primary-500">Financial Operating System?</span>
            </h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-10 leading-relaxed">
              Join the forward-thinking businesses that have already consolidated their global finance with Lydiam.
            </p>
